...
@Configuration
@ComponentScan(basePackages = "first_project")
...
public class SpringConfig implements WebMvcConfigurer {
    ...
    /// для создания бина JDBC Template нам нужно создать бин DataSource
    // используем файл application.properties
    @Bean
    ...
    //теперь можно создать bean JDBC Template
    // jdbc template это обертка для jbbc
    @Bean
